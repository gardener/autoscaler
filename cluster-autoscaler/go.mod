...
require (
	...
	github.com/gardener/machine-controller-manager-provider-azure v0.21.0
...
require (
	...
	github.com/Azure/azure-sdk-for-go/sdk/resourcemanager/containerservice/armcontainerservice/v5 v5.1.0-beta.2 // indirect
