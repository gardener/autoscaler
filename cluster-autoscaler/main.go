...
func main() {
	...
	flag.Set("legacy_stderr_threshold_behavior", "false") // #nosec G104 (CWE-703) -- flag.Set error is non-fatal; code inherited from upstream
	// Preserve backward-compatible default; users can override to WARNING or ERROR.
	flag.Set("stderrthreshold", "INFO") // #nosec G104 (CWE-703) -- flag.Set error is non-fatal; code inherited from upstream
